    ...
    public function run(): void
    {
        ...
        $testimonials = [
            [
                ...
                'profile_name' => 'newton-mutharimi-profile.webp',
                'cover_source' => 'public/team-newton-mutharimi.png',
                'cover_name' => 'newton-mutharimi.webp',
                'youtube_link' => null,
            ...
            [
                ...
                'profile_name' => 'lyn-mulati-profile.webp',
                'cover_source' => 'public/team-lyn-mulati.png',
                'cover_name' => 'lyn-mulati.webp',
                'youtube_link' => null,
        ...
        foreach ($testimonials as $data) {
            $profilePath = SeedImage::storeOptimized(
                base_path($data['profile_source']),
                $profileDir . DIRECTORY_SEPARATOR . $data['profile_name'],
                70,
                480
            );
            $coverPath = SeedImage::storeOptimized(
                base_path($data['cover_source']),
